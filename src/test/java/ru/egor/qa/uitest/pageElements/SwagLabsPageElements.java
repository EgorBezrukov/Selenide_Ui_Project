package ru.egor.qa.uitest.pageElements;
...
public abstract class SwagLabsPageElements {
    ...
    protected final SelenideElement sideBarButton = $("#react-burger-menu-btn");
    protected final SelenideElement sideBarLogout = $("#logout_sidebar_link");
}
